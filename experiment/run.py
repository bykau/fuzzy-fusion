...
if __name__ == '__main__':
    ...
    for pi in [1., 0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55, 0.5]:
        ...
        for i in range(10):
            ...
            # t_gf = time.time()
            gf_d, gf_it, accuracy_gf, pi_gf = gibbs_fuzzy(data=data, accuracy_data=accuracy_data, g_data=g_data,
            ...
            result_list.append([pi, m_v, em_d, em_f, gf_d])
    ...
    df_data = pd.DataFrame(data=result_list, columns=['pi', 'mv', 'em', 'em_f', 'gf'])
